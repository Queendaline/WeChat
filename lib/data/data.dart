import 'package:wechat/models.dart/post_model.dart';
import 'package:wechat/models.dart/story_model.dart';
...
final List<Post> posts = [
  ...
  Post(
    id: 4,
    user: onlineUsers[3],
    caption: "I'm fine, thank you, how about you",
    timeAgo: '15hr',
    imageUrl:
  ...
  Post(
    id: 5,
    user: onlineUsers[0],
    caption: "I'm good, Are you going swimming with us",
    timeAgo: '1d',
    imageUrl: 'null',
    likes: 482,
    comments: 37,
  ...
  Post(
    id: 6,
    user: onlineUsers[9],
    caption: 'Uhmm yeah, let me check with my parents, i will be right back',
    timeAgo: '1d',
    imageUrl:
